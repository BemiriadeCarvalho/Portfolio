import profileImg from "../assets/Gemini_....png";
...
export const portfolio = {
  ...
  profile: {
    ...
    photo: profileImg, // substituir por um URL externo, se preferires
    ...
    items: [
      {
        name: "Metaverso",
        description:
          "Desenvolvimento de aplicação web full-stack (Metaverso) em tempo real com Sockets, autenticação de 
utilizadores, gestão de sessões e arquitetura cliente-servidor.",
      ...
      },
      {
        name: "Webserv",
        description:
          "Implementação de servidor HTTP em C, com gestão de conexões, parsing de requests, sockets e múltiplos 
clientes.",
